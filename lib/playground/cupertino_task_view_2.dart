...
class CupertinoTaskView2 extends StatefulWidget {
  final double pageWidth;
  final IndexedWidgetBuilder builder;
  const CupertinoTaskView2(
      {Key? key, required this.builder, required this.pageWidth})
      : super(key: key);

  @override
  _CupertinoTaskView2State createState() => _CupertinoTaskView2State();
}

class _CupertinoTaskView2State extends State<CupertinoTaskView2> {
  @override
  Widget build(BuildContext context) {
    return CustomScrollView(
      scrollDirection: Axis.horizontal,
      physics: CustomPageScrollPhysics(width: widget.pageWidth),
      slivers: [
        CupertinoList(
...
class CupertinoList extends SliverMultiBoxAdaptorWidget {
  ...
  @override
  RenderCupertinoList createRenderObject(BuildContext context) {
    final SliverMultiBoxAdaptorElement element =
        context as SliverMultiBoxAdaptorElement;
    return RenderCupertinoList(childManager: element);
  }
}

class RenderCupertinoList extends RenderSliverMultiBoxAdaptor {
  ...
  double _childSlideValue(RenderBox child) {
    return (constraints.scrollOffset + (indexOf(child) * -10));
  }
